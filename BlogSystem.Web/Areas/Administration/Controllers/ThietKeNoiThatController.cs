namespace BlogSystem.Web.Areas.Administration.Controllers
{
    ...
    public class ThietKeNoiThatController : AdministrationController
    {
        private readonly IDbRepository<Page> pagesData;
        private readonly IUrlGenerator urlGenerator;

        public ThietKeNoiThatController(IDbRepository<Page> pagesData, IUrlGenerator urlGenerator)
        {
        ...
        public ActionResult Index()
        {
            ...
            var pages = this.Mapper.Map<ThietKeNoiThatViewModel>(allPages).ToList();
        ...
        public ActionResult Create(ThietKeNoiThatViewModel model)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var model = this.Mapper.Map<ThietKeNoiThatViewModel>(page);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(ThietKeNoiThatViewModel model)
        {
            if (model != null && this.ModelState.IsValid)
            {
