namespace BlogSystem.Web.Areas.Administration.Controllers
{
    ...
    public class CollectionController : AdministrationController
    {
        private readonly IDbRepository<Comment> commentsData;
        private readonly ISanitizer sanitizer;

        public CollectionController(IDbRepository<Comment> commentsData, ISanitizer sanitizer)
        {
        ...
        public ActionResult Index(int page = 1, int perPage = GlobalConstants.DefaultPageSize)
        {
            ...
            var comments = this.Mapper.Map<CollectionViewModel>(allComments).ToList();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var model = this.Mapper.Map<CollectionViewModel>(comment);
